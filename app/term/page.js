...
export default function TermPage() {
  return (
    <div className="max-w-2xl mx-auto p-6 rounded-lg shadow mt-8 mb-16">
      <h1 className="text-2xl font-bold mb-6 text-center">利用規約</h1>
      <div className="space-y-6 text-sm leading-relaxed">
        <p>この利用規約（以下、「本規約」といいます。）は、ノビシロノカタマリ（以下、「当団体」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。</p>

        <h2 className="font-bold mt-6">第1条（適用）</h2>
        ...
        <h2 className="font-bold mt-6">第2条（利用登録）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第4条（禁止事項）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第5条（本サービスの提供の停止等）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第6条（利用制限および登録抹消）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第7条（保証の否認および免責事項）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第8条（サービス内容の変更等）</h2>
        <ol className="list-decimal ml-6 space-y-1">
          <li>当団体は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</li>
        </ol>

        <h2 className="font-bold mt-6">第9条（利用規約の変更）</h2>
        <ol className="list-decimal ml-6 space-y-1">
          <li>当団体は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。
            <ol className="list-decimal ml-6 mt-1">
        ...
        <h2 className="font-bold mt-6">第10条（通知または連絡）</h2>
        <ol className="list-decimal ml-6 space-y-1">
