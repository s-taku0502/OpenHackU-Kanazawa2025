  ...
  return (
    <div className="max-w-2xl mx-auto p-6 rounded-lg shadow mt-8 mb-16">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="font-bold mt-6">第5条（禁止事項）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第6条（本サービスの提供の停止等）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第7条（利用制限および登録抹消）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第9条（保証の否認および免責事項）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第10条（サービス内容の変更等）</h2>
        <ol className="list-decimal ml-6 space-y-1">
          <li>当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</li>
        </ol>

        <h2 className="font-bold mt-6">第11条（利用規約の変更）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第13条（通知または連絡）</h2>
        <ol className="list-decimal ml-6 space-y-1">
        ...
        <h2 className="font-bold mt-6">第14条（権利義務の譲渡の禁止）</h2>
        <ol className="list-decimal ml-6 space-y-1">
          <li>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</li>
        </ol>

        <h2 className="font-bold mt-6">第15条（準拠法・裁判管轄）</h2>
        <ol className="list-decimal ml-6 space-y-1">
